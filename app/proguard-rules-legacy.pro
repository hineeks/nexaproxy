...
# Revision: '0'
# ABI: 'x86'
# pid: 6560, tid: 6588, name: DefaultDispatch  >>> com.hineeks.nexaproxy:bg <<<
...
# backtrace:
#     #00 pc 00feb747  /data/dalvik-cache/x86/data@app@com.hineeks.nexaproxy-2@base.apk@classes.dex
