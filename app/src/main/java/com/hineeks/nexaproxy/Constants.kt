...
object Action {
    const val SERVICE = "com.hineeks.nexaproxy.SERVICE"
    const val CLOSE = "com.hineeks.nexaproxy.CLOSE"
    const val RELOAD = "com.hineeks.nexaproxy.RELOAD"
    const val ABORT = "com.hineeks.nexaproxy.ABORT"

    const val THEME_CHANGED = "com.hineeks.nexaproxy.THEME_CHANGED"

    const val EXTRA_PROFILE_ID = "com.hineeks.nexaproxy.EXTRA_PROFILE_ID"
}
