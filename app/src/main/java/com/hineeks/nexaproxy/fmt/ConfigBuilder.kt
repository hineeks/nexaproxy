...
import com.hineeks.nexaproxy.LogLevel
import com.hineeks.nexaproxy.RouteMode
import com.hineeks.nexaproxy.NexaProxy
import com.hineeks.nexaproxy.TLS_FRAGMENTATION_METHOD
import com.hineeks.nexaproxy.TunImplementation
import com.hineeks.nexaproxy.bg.VpnService
...
import com.hineeks.nexaproxy.fmt.V2rayBuildResult.IndexEntity
import com.hineeks.nexaproxy.fmt.anytls.AnyTLSBean
import com.hineeks.nexaproxy.fmt.gson.gson
...
import com.hineeks.nexaproxy.fmt.v2ray.StandardV2RayBean
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.BrowserDialerObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.BrowserForwarderObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.DNSOutboundConfigurationObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.DnsObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.DokodemoDoorInboundConfigurationObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.FakeDnsObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.FreedomOutboundConfigurationObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.GrpcObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.HTTPInboundConfigurationObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.HTTPOutboundConfigurationObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.HTTPUpgradeObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.HttpObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.Hysteria2Object
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.Hysteria2OutboundConfigurationObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.InboundObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.KcpObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.LazyInboundConfigurationObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.LazyOutboundConfigurationObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.LogObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.MeekObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.MekyaObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.MultiObservatoryObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.ObservatoryObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.OutboundObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.PolicyObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.QuicObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.RealityObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.RoutingObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.RoutingObject.BalancerObject.StrategyObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.SSHOutboundConfigurationObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.ShadowsocksOutboundConfigurationObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.SocksInboundConfigurationObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.SocksOutboundConfigurationObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.SplitHTTPObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.StreamSettingsObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.TLSObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.TcpObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.TrojanOutboundConfigurationObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.VLESSOutboundConfigurationObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.VMessOutboundConfigurationObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.WebSocketObject
import com.hineeks.nexaproxy.fmt.v2ray.V2RayConfig.WireGuardOutboundConfigurationObject
import com.hineeks.nexaproxy.fmt.v2ray.VLESSBean
import com.hineeks.nexaproxy.fmt.v2ray.VMessBean
import com.hineeks.nexaproxy.fmt.v2ray.getXrayRange
import com.hineeks.nexaproxy.fmt.wireguard.WireGuardBean
import com.hineeks.nexaproxy.ktx.app
import com.hineeks.nexaproxy.ktx.getArray
import com.hineeks.nexaproxy.ktx.getBoolean
import com.hineeks.nexaproxy.ktx.getBooleanProperty
import com.hineeks.nexaproxy.ktx.getObject
import com.hineeks.nexaproxy.ktx.getString
import com.hineeks.nexaproxy.ktx.getStringArray
import com.hineeks.nexaproxy.ktx.isValidHysteriaMultiPort
import com.hineeks.nexaproxy.ktx.joinHostPort
import com.hineeks.nexaproxy.ktx.listByLine
import com.hineeks.nexaproxy.ktx.listByLineOrComma
import com.hineeks.nexaproxy.ktx.mkPort
import com.hineeks.nexaproxy.ktx.parseJson
import com.hineeks.nexaproxy.ktx.toHysteriaPort
import com.hineeks.nexaproxy.ktx.unescapeLineFeed
...
fun buildV2RayConfig(
    ...
    fun ProxyEntity.resolveChainRecursively(): MutableList<ProxyEntity> {
        when (type) {
            ...
            ProxyEntity.TYPE_CHAIN -> {
                val beans = NexaProxyDatabase.proxyDao.getEntities(chainBean!!.proxies)
    ...
    fun ProxyEntity.resolveChain(): MutableList<ProxyEntity> {
        if (type == ProxyEntity.TYPE_BALANCER) {
            val beans = if (balancerBean!!.type == BalancerBean.TYPE_LIST) {
                NexaProxyDatabase.proxyDao.getEntities(balancerBean!!.proxies)
            } else {
                NexaProxyDatabase.proxyDao.getByGroup(balancerBean!!.groupId)
        ...
        NexaProxyDatabase.groupDao.getById(groupId)?.let { group ->
            group.frontProxy.takeIf { it > 0L }?.let { id ->
                NexaProxyDatabase.proxyDao.getById(id)?.let {
                    when (it.type) {
    ...
    val extraRules = if (forTest || routeMode != RouteMode.RULE) listOf() else NexaProxyDatabase.rulesDao.enabledRules()
    val extraProxies = if (forTest) mapOf() else NexaProxyDatabase.proxyDao.getEntities(extraRules.mapNotNull { rule ->
    ...
    V2RayConfig().apply {
        ...
        if (!forTest) {
            if (!forExport) {
                inbounds.add(InboundObject().apply {
                    tag = "ipc-in"
                    protocol = "ipc"
                    val path = NexaProxy.deviceStorage.noBackupFilesDir.toString() + "/ipc.sock"
        ...
        fun buildChain(
                                                            ...
                                                            try {
                                                                PluginManager.init(pluginConfiguration)?.let { (path, opts, isV2) ->
                                                                    ...
                                                                    val shouldProtect = if (forTest) {
                                                                        DataStore.serviceMode == Key.MODE_VPN && DataStore.tunImplementation == TunImplementation.SYSTEM && DataStore.startedProfile > 0 && NexaProxy.started
                                                                    } else {
                                                                        DataStore.serviceMode == Key.MODE_VPN && DataStore.tunImplementation == TunImplementation.SYSTEM
                                                                    }
                                                                    if (shouldProtect) {
                                                                        pluginWorkingDir = NexaProxy.deviceStorage.noBackupFilesDir.toString()
                                                                        if (isV2) {
                                                                            opts["__android_vpn"] = ""
                                                                        } else {
                                                                            pluginArgs = listOf("-V")
            ...
            if (isBalancer) {
                ...
                if (shouldUseLandingProxy) {
                    ...
                    val group = NexaProxyDatabase.groupDao.getById(balancerBean.groupId)
                    val landingProxyEntity = if (group != null && group.landingProxy > 0L) {
                        NexaProxyDatabase.proxyDao.getById(group.landingProxy)
                    } else null
                ...
                if (shouldUseFrontProxy) {
                    ...
                    val frontProxyEntity = if (group != null && group.frontProxy > 0L) {
                        NexaProxyDatabase.proxyDao.getById(group.frontProxy)
                    } else null
            ...
            routing.rules.add(RoutingObject.RuleObject().apply {
                ...
                if (!forExport && !forTest && rule.ssid.isNotEmpty() && Build.VERSION.SDK_INT >= Build.VERSION_CODES.O_MR1) {
                    ...
                    val isLocationServiceEnabled = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
                        NexaProxy.location.isLocationEnabled
                    } else {
                        try {
        ...
        if (!forTest && !forExport) {
            inbounds.add(InboundObject().apply {
                tag = TAG_DNS_IN
                val path = NexaProxy.deviceStorage.noBackupFilesDir.toString() + "/ipc_dns.sock"
                val udsFile = File(path)
                if (udsFile.exists()) udsFile.delete()
                listen = path
                protocol = "dokodemo-door"
