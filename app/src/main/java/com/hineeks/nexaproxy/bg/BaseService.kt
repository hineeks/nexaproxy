...
import android.os.*
import com.hineeks.nexaproxy.Action
import com.hineeks.nexaproxy.BootReceiver
import com.hineeks.nexaproxy.R
import com.hineeks.nexaproxy.aidl.AppStatsList
...
import com.hineeks.nexaproxy.bg.proto.ProxyInstance
import com.hineeks.nexaproxy.database.DataStore
import com.hineeks.nexaproxy.database.NexaProxyDatabase
import com.hineeks.nexaproxy.fmt.Alerts
import com.hineeks.nexaproxy.fmt.TAG_SOCKS
...
import com.hineeks.nexaproxy.aidl.AppStats as AidlAppStats
...
class BaseService {
    ...
    class Binder(private var data: Data? = null) : INexaProxyService.Stub(),
        CoroutineScope,
        AutoCloseable,
        TrafficListener {
        private val callbacks = object : RemoteCallbackList<INexaProxyServiceCallback>() {
            override fun onCallbackDied(callback: INexaProxyServiceCallback?, cookie: Any?) {
        ...
        override fun registerCallback(cb: INexaProxyServiceCallback) {
            callbacks.register(cb)
        }

        private val broadcastLock = Mutex()
        suspend fun broadcast(work: (INexaProxyServiceCallback) -> Unit) {
        ...
        override fun stopListeningForBandwidth(cb: INexaProxyServiceCallback) {
            launch {
        ...
        override fun unregisterCallback(cb: INexaProxyServiceCallback) {
        ...
        override fun startListeningForStats(cb: INexaProxyServiceCallback, timeout: Long) {
            launch {
        ...
        override fun stopListeningForStats(cb: INexaProxyServiceCallback) {
            launch {
        ...
        override fun resetTrafficStats() {
            runOnDefaultDispatcher {
                NexaProxyDatabase.statsDao.deleteAll()
    ...
    interface Interface {
        ...
        fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
            ...
            val profile = NexaProxyDatabase.proxyDao.getById(DataStore.selectedProxy)
            this as Context
            ...
            val group = NexaProxyDatabase.groupDao.getById(profile.groupId)
