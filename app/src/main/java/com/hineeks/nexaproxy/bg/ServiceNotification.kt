...
import com.hineeks.nexaproxy.ui.SwitchActivity
...
class ServiceNotification(
    ...
    private val callback: INexaProxyServiceCallback by lazy {
        object : INexaProxyServiceCallback.Stub() {
    ...
    private val builder = NotificationCompat.Builder(service as Context, channel)
        ...
        .setContentIntent(NexaProxy.configureIntent(service))
