...
@RequiresApi(24)
class TileService : BaseTileService(), NexaProxyConnection.Callback {
    ...
    private fun toggle() {
        ...
        if (service == null) tapPending =
            ...
            when {
                state.canStop -> NexaProxy.stopService()
                state == BaseService.State.Stopped -> NexaProxy.startService()
            }
        }
    }
}
