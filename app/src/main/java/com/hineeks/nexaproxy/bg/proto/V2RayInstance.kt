...
package com.hineeks.nexaproxy.bg.proto
...
import com.hineeks.nexaproxy.RootCAProvider
import com.hineeks.nexaproxy.NexaProxy
import com.hineeks.nexaproxy.bg.AbstractInstance
...
import com.hineeks.nexaproxy.fmt.V2rayBuildResult
...
abstract class V2RayInstance(
    ...
    override fun launch() {
        val context = NexaProxy.application
        for ((_, chain) in config.index) {
            chain.entries.forEachIndexed { _, (triple, profile) ->
                val port = triple.first
