...
import com.hineeks.nexaproxy.aidl.*
import com.hineeks.nexaproxy.database.DataStore
import com.hineeks.nexaproxy.ktx.runOnMainDispatcher

class NexaProxyConnection(private var listenForDeath: Boolean = false) : ServiceConnection,
    ...
    interface Callback {
        ...
        fun onServiceConnected(service: INexaProxyService)
    ...
    private val serviceCallback = object : INexaProxyServiceCallback.Stub() {
        override fun stateChanged(state: Int, profileName: String?, msg: String?) {
            val s = BaseService.State.entries[state]
            NexaProxy.started = s.canStop
    ...
    var service: INexaProxyService? = null

    override fun onServiceConnected(name: ComponentName?, binder: IBinder) {
        this.binder = binder
        val service = INexaProxyService.Stub.asInterface(binder)!!
