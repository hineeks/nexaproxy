...
import com.hineeks.nexaproxy.ktx.use
import java.io.*
...
object CrashHandler : Thread.UncaughtExceptionHandler {
    ...
    override fun uncaughtException(thread: Thread, throwable: Throwable) {
        ...
        Log.e("NexaProxy", "uncaughtException", throwable)

        val logFile = File.createTempFile("NexaProxy Crash Report ",
            ".log",
    ...
    fun buildReportHeader(): String {
        var report = ""
        report += "NexaProxy ${BuildConfig.VERSION_NAME} (${BuildConfig.VERSION_CODE}) ${BuildConfig.FLAVOR.uppercase()}\n"
