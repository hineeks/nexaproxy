...
import com.hineeks.nexaproxy.fmt.shadowsocks.supportedShadowsocks2022Method
...
import com.hineeks.nexaproxy.fmt.v2ray.getXrayRangeAsTriple
import com.hineeks.nexaproxy.fmt.v2ray.legacyVlessFlow
import com.hineeks.nexaproxy.fmt.v2ray.nonRawTransportName
import com.hineeks.nexaproxy.fmt.v2ray.parseRayUUID
import com.hineeks.nexaproxy.fmt.v2ray.supportedKcpQuicHeaderType
import com.hineeks.nexaproxy.fmt.v2ray.supportedQuicSecurity
import com.hineeks.nexaproxy.fmt.v2ray.supportedVlessFlow
import com.hineeks.nexaproxy.fmt.v2ray.supportedVmessMethod
import com.hineeks.nexaproxy.fmt.v2ray.supportedXhttpMode
...
fun parseV2RayOutbound(outbound: JsonObject): List<AbstractBean> {
    // v2ray JSONv4 config, Xray config and JSONv4 config of NexaProxy's v2ray fork only
