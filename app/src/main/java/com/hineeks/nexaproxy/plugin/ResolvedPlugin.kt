...
import com.hineeks.nexaproxy.plugin.PluginManager.loadString
...
abstract class ResolvedPlugin(protected val resolveInfo: ResolveInfo) : Plugin() {
    ...
    override val version by lazy {
        NexaProxy.application.getPackageInfo(componentInfo.packageName).versionCode
    }
    override val versionName: String by lazy {
        NexaProxy.application.getPackageInfo(componentInfo.packageName).versionName!!
    }
    override val label: CharSequence get() = resolveInfo.loadLabel(NexaProxy.application.packageManager)
    override val icon: Drawable get() = resolveInfo.loadIcon(NexaProxy.application.packageManager)
