...
import com.hineeks.nexaproxy.ktx.dp2pxf
import com.hineeks.nexaproxy.ktx.snackbar
                ...
                return MaterialAboutList.Builder()
                    .addCard(MaterialAboutCard.Builder()
                        ...
                        .addItem(MaterialAboutActionItem.Builder()
                            ...
                            .setOnClickAction {
                                startActivity(Intent(
                                    Intent.ACTION_VIEW,
                                    "https://github.com/hineeks/nexaproxy/releases".toUri()
                                ))
                            }
                            .setOnLongClickAction {
                        ...
                        .addItem(MaterialAboutActionItem.Builder()
                            ...
                            .text(getString(R.string.version_x, "nexaproxy-core"))
                            .subText(Libexclavecore.getV2RayVersion())
                            .setOnClickAction {
                                startActivity(Intent(
                                    Intent.ACTION_VIEW,
                                    "https://github.com/hineeks/nexaproxy".toUri()
                                ))
                            }
                            .build())
                        .addItem(MaterialAboutActionItem.Builder()
