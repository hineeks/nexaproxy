...
import com.hineeks.nexaproxy.databinding.LayoutAssetItemBinding
import com.hineeks.nexaproxy.databinding.LayoutAssetsBinding
...
class AssetsActivity : ThemedActivity() {
    ...
    inner class AssetAdapter : RecyclerView.Adapter<AssetHolder>(),
        ...
        fun reloadAssets() {
            ...
            val managedAssets = NexaProxyDatabase.assetDao.getAll().associateBy { it.name }
        ...
        override fun commit(actions: List<Pair<Int, File>>) {
            ...
            runOnDefaultDispatcher {
                groups.forEach {
                    ...
                    NexaProxyDatabase.assetDao.delete(it.name)
                }
            }
        }
    ...
    inner class AssetHolder(val binding: LayoutAssetItemBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(file: File) {
            ...
            val assetEntity = NexaProxyDatabase.assetDao.get(file.name)
