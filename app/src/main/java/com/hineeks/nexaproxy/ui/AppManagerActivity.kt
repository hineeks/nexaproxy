...
import com.hineeks.nexaproxy.databinding.LayoutAppsBinding
import com.hineeks.nexaproxy.databinding.LayoutAppsItemBinding
import com.hineeks.nexaproxy.ktx.crossFadeFrom
import com.hineeks.nexaproxy.ktx.dp2px
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.action_export_clipboard -> {
                val success = NexaProxy.trySetPrimaryClip("${DataStore.bypass}\n${DataStore.individual}")
                Snackbar.make(
                    binding.list,
            ...
            R.id.action_import_clipboard -> {
                val proxiedAppString = NexaProxy.clipboard.primaryClip?.getItemAt(0)?.text?.toString()
