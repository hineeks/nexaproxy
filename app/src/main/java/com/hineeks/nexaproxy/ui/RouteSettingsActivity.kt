...
import com.hineeks.nexaproxy.widget.AppListPreference
...
class RouteSettingsActivity(
        ...
        if (savedInstanceState == null) {
            ...
            runOnDefaultDispatcher {
                if (editingId == 0L) {
                    ...
                    val ruleEntity = NexaProxyDatabase.rulesDao.getById(editingId)
                    if (ruleEntity == null) {
                        onMainDispatcher {
                            finish()
                        }
    ...
    suspend fun saveAndExit() {
        ...
        if (editingId == 0L) {
            ...
            val entity = NexaProxyDatabase.rulesDao.getById(DataStore.editingId)
            if (entity == null) {
                finish()
                return
            }
