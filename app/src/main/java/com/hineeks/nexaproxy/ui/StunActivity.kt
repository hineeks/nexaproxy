...
import com.hineeks.nexaproxy.databinding.LayoutStunBinding
import com.hineeks.nexaproxy.ktx.PUBLIC_STUN_SERVERS
        ...
        runOnDefaultDispatcher {
            val stunClient = Libexclavecore.newStunClient().apply {
                if (NexaProxy.started && DataStore.startedProfile > 0) {
                    ...
                    useDNSUDS(NexaProxy.deviceStorage.noBackupFilesDir.toString() + "/ipc_dns.sock")
                }
            }
