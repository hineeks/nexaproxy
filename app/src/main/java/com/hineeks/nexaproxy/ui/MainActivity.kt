...
import com.hineeks.nexaproxy.aidl.AppStats
...
import com.hineeks.nexaproxy.database.preference.OnPreferenceDataStoreChangeListener
import com.hineeks.nexaproxy.databinding.LayoutMainBinding
import com.hineeks.nexaproxy.fmt.AbstractBean
import com.hineeks.nexaproxy.fmt.Alerts
import com.hineeks.nexaproxy.fmt.PluginEntry
import com.hineeks.nexaproxy.group.GroupInterfaceAdapter
...
class MainActivity : ThemedActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (themeResId !in intArrayOf(
                R.style.Theme_NexaProxy_Black, R.style.Theme_NexaProxy_LightBlack
            )
        ) {
        ...
        binding.fab.setOnClickListener {
            if (state.canStop) NexaProxy.stopService() else connect.launch(
                null
            )
        }
    ...
    override fun onNewIntent(intent: Intent) {
        ...
        runOnDefaultDispatcher {
            if (uri.scheme == "nexaproxy" && uri.host == "subscription") {
    ...
    val connection = NexaProxyConnection(true)
    override fun onServiceConnected(service: INexaProxyService) = changeState(try {
        BaseService.State.entries[service.state].also {
            NexaProxy.started = it.canStop
        }
