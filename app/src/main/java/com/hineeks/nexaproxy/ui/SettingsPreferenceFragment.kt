...
import com.hineeks.nexaproxy.Key.MODE_VPN
...
import com.hineeks.nexaproxy.ui.profile.ProfileSettingsActivity
import com.hineeks.nexaproxy.utils.PackageCache
import com.hineeks.nexaproxy.utils.Theme
import com.hineeks.nexaproxy.widget.ColorPickerPreference
import com.hineeks.nexaproxy.widget.LinkOrContentPreference
            ...
            if (newValue as Boolean) {
                ...
                MaterialAlertDialogBuilder(requireContext()).apply {
                    ...
                    setNegativeButton(android.R.string.copy) { _, _ ->
                        NexaProxy.trySetPrimaryClip(path)
